<template>
  ...
  >
    <div
      class="picture mb-4 text-greyscale-300"
      :class="userData.profilePic === '' ? 'empty bg-primray-100' : ''"
    >
      <i
        v-if="userData.profilePic === ''"
        class="icon-user text-primary-500"
      ></i>
    ...
    <div class="flex justify-center">
      <span
        class="user-role py-2 px-3 font-bold sato-l-xs uppercase text-ternary-500 bg-ternary-100 mt-4"
      >
        {{ userData.role }}
      </span>
    </div>
