<template>
	...
	<main v-else-if="compagnie.name" class="main-view dashboard" :class="isSidebarCollapsed ? 'collapsed ' : ''">
			...
			<div class="stat-bar mt-6 flex">
				...
				<stat-card
					:stat="{
						...
						mainValue: 7,
						mainUnit: '',
						secondaryValue: compagnieTempalesNb,
						secondaryUnit: '',
						link: 'dashboard-analytics',
					}"
				/>
