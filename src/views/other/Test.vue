  ...
  <div class="p-6">
    <div class="text-semantic-positive-500 bg-background-100">
      ...
      <div>
        ...
        <Btn color="semantic-info" icon secondary>
          <i class="icon-call"></i
        ></Btn>
        <Btn color="semantic-warning" secondary class="mb-2">
          test secondary</Btn
        >
        ...
        <Btn color="semantic-info" icon ternary class="mb-2" disabled>
          <i class="icon-call"></i
        ></Btn>
      ...
      <nav-bar
        v-model="navBarTest"
        :items="['gauche', 'droite', 'en bas', 'en haut']"
      />
